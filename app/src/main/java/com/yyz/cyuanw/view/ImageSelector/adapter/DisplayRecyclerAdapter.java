...
import com.yyz.cyuanw.view.ImageSelector.interf.OnMoveAndSwipedListener;
import com.yyz.cyuanw.view.ImageSelector.interf.OnOperateListener;
import com.yyz.cyuanw.view.ImageSelector.widget.PickRecyclerView;
import com.yyz.cyuanw.view.ImageSelector.widget.SquareRelativeLayout;
...
//                .override(mImageWh, mImageWh)
            ...
            mRequestManager
                    ...
                    .apply(new RequestOptions().centerCrop()
                            .placeholder(path.contains("http") ? App.context.getResources().getDrawable(R.mipmap.ic_cy) : App.context.getResources().getDrawable(R.mipmap.ic_addpic) )
...
//            });
    ...
    public void onViewRecycled(ViewHolder holder) {
        Glide.with(App.context).clear(holder.mPicIv);
