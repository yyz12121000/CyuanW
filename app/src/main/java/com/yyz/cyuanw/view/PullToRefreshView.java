...
public class PullToRefreshView extends LinearLayout {
    ...
    private void addHeaderView() {
        ...
        mHeaderView = mInflater.inflate(R.layout.view_refresh_header, this,
                false);

        mHeaderImageView = (ImageView) mHeaderView
                .findViewById(R.id.refresh_image);
        mHeaderTextView = (TextView) mHeaderView
                .findViewById(R.id.refresh_text);

        mHeaderProgressBar = (RelativeLayout) mHeaderView
                .findViewById(R.id.refreshProgressLayout);
        // header layout
    ...
    private void addFooterView() {
        ...
        mFooterView = mInflater.inflate(R.layout.view_refresh_footer, this,
                false);
        ...
        mFooterProgressBar = (RelativeLayout) mFooterView
                .findViewById(R.id.loadProgressLayout);
        // footer layout
    ...
    private boolean isRefreshViewScroll(int deltaY) {
        ...
        if (mAdapterView != null) {
            ...
            if (deltaY > 5) {
                ...
                if (child != null && mAdapterView.getFirstVisiblePosition() == 0
                        && child.getTop() == 0) {
