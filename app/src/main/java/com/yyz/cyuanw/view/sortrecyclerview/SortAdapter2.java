...
public class SortAdapter2 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private LayoutInflater mInflater;
    private List<Data9> mData = new ArrayList<>();
    private List<Data9> topList = new ArrayList<>();
    ...
    public void setTopData(List<Data9> data) {
        topList = data;
        ...
        if (mOnItemClickListener != null) {
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    mOnItemClickListener.onItemClick(holder.itemView, mData.get(position).id);
                }
            });
...
//        });
    ...
    public class ViewTopHolder extends RecyclerView.ViewHolder {
        ...
        public void setData(List<Data9> list) {
...
*/
     ...
     * @param list
     */
    public void updateList(List<Data9> list) {
        this.mData = list;
        notifyDataSetChanged();
    }
